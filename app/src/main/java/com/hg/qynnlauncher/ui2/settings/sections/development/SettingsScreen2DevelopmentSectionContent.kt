    ...
    ActionCard(
        ...
        descriptionParagraphs = listOf(
            "You will be prompted to select a directory. "
                    ...
                    + "These files help mock the QYNN JS to Android API for development purposes.",
            "More information is available on the project home page - link in the \"About QYNN\" section near the bottom of this screen.",
        ),
        modifier = modifier,
    )
    {
