package com.hg.qynnlauncher.services.apps
...
)
{
    ...
    // region receiving notifications from QYNNLauncherBroadcastReciever

    // these functions could theoretically be replaced with collecting an event flow from the QYNNLauncherBroadcastReceiver (BLBR) instead,
