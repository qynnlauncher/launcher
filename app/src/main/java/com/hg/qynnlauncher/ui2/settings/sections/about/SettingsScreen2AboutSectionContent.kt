package com.hg.qynnlauncher.ui2.settings.sections.about
...
)
{
    ...
    )
    {
        Column(
            ...
            Text("Designed & written by HG.")
            Text("QYNN Launcher is my attempt at making launcher development approachable by reducing dealing with Android to using a simple API.")
        ...
        Btn(text = "Project home", suffixIcon = R.drawable.ic_open_in_new, onClick = {
            context.startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/QYNNLauncher")))
        })
    }
}
